...
$html = file_get_contents("http://www.imdb.com/movies-in-theaters/?ref_=cs_inth", false, $context);
 ...
 $connection = mysqli_connect("localhost","c6heer","ccKcJ0!4","c6heer"); 
   ...
   foreach ($movies as $movie){
	   ...
	   if($num_rows<1){
		   ...
		   $insert = "INSERT INTO `imdb_movies`( `title`, `genre`, `director`, `stars`, `description`, `image`, `duration`,`imdb_rating`) VALUES('$title','$genre','$Director','$stars','$Description','$imagename','$Duration','$imdb_rating')";
