...
$connection = mysqli_connect("localhost","c6heer","ccKcJ0!4","c6heer"); 
   ...
   foreach ($movies as $movie){
	   ...
	   if($num_rows<1){
		...
		echo   $insert = "INSERT INTO `imdb_movies`( `title`, `genre`, `director`, `stars`, `description`, `image`, `duration`) VALUES('$title','$genre','$Director','$stars','$Description','$imagename','$Duration')";
